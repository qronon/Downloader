...
public class SiteListActivity extends SherlockActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View v, int i,
				...
				if(i == list.size()){
			        loadPage(++page);
					Toast.makeText(SiteListActivity.this, getString(R.string.loading_page_x).replace("%", String.valueOf(page)), 3).show();
				}
			}
		});
    }
